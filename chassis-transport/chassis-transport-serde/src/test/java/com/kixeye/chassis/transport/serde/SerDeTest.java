...
public class SerDeTest {
	...
	private static final Random RAND = new Random(SerDeTest.class.hashCode() + System.nanoTime());
	...
	public static class TestObject {
		...
		public static TestObject generateRandom(int innerObjectCount, boolean createInnerObjectList) {
			...
			obj.sampleString = RandomStringUtils.randomAlphanumeric(30);
			obj.sampleBoolean = RAND.nextBoolean();
			obj.sampleByte = (byte)RAND.nextInt();
			obj.sampleChar = RandomStringUtils.randomAlphanumeric(1).charAt(0);
			...
			obj.sampleStringArray = new String[] { RandomStringUtils.randomAlphanumeric(30), RandomStringUtils.randomAlphanumeric(30) };
			...
			obj.sampleCharArray = new char[] { RandomStringUtils.randomAlphanumeric(1).charAt(0), RandomStringUtils.randomAlphanumeric(1).charAt(0) };
